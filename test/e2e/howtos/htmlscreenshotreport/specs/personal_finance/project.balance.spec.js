...
describe('Project balance of the Personal finance', function () {
  ...
  it("should project the correct balance for the stated personal finance details", function () {
    ...
    expect(balanceProjectorPage.netIncomePerMonth).toEqual('2700');
    // expect(balanceProjectorPage.netIncomePerMonth).toEqual('3000');
    expect(balanceProjectorPage.netIncomePerYear).toEqual('32900');
    // expect(balanceProjectorPage.netIncomePerYear).toEqual('35900');
  ...
  it("should project the correct balance for the stated personal finance details", function () {
    ...
    expect(browser.getTitle()).toEqual('Crooked Firebase App');
    ...
    expect(balanceProjectorPage.monthlyBalanceAt(0)).toEqual('0');
    expect(balanceProjectorPage.monthlyBalanceAt(1)).toEqual('0');
    expect(balanceProjectorPage.monthlyBalanceAt(2)).toEqual('0');
    expect(balanceProjectorPage.monthlyBalanceAt(3)).toEqual('0');
    expect(balanceProjectorPage.monthlyBalanceAt(4)).toEqual('0');
    expect(balanceProjectorPage.monthlyBalanceAt(5)).toEqual('0');
    expect(balanceProjectorPage.monthlyBalanceAt(6)).toEqual('0');
    expect(balanceProjectorPage.monthlyBalanceAt(7)).toEqual('0');
    expect(balanceProjectorPage.monthlyBalanceAt(8)).toEqual('0');
    expect(balanceProjectorPage.monthlyBalanceAt(9)).toEqual('0');
    expect(balanceProjectorPage.monthlyBalanceAt(10)).toEqual('0');
    expect(balanceProjectorPage.monthlyBalanceAt(11)).toEqual('0');
