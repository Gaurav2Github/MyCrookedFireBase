 ...
 */
 ...
 exports.config = {
  ...
  //Refer following link for more details on protractor-jasmine2-screenshot-reporter:
  //https://github.com/mlison/protractor-jasmine2-screenshot-reporter
  jasmine.getEnv().addReporter(
    new HtmlScreenshotReporter({
      dest: 'test/e2e/howtos/htmlscreenshotreport/test-report',
      pathBuilder: function(currentSpec, suites, browserCapabilities) {
      // will return your-spec-name.png
      return browser.browserName + '/' +currentSpec.fullName;
      },
